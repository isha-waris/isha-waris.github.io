...
const Contact = () => {
  return (
    <section
      id="contact"
      className="bg-gradient-to-b from-gray-900 via-gray-950 to-black py-20"
    >
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card className="w-full group relative overflow-hidden border border-gray-700 bg-gray-900 shadow-lg transition-all duration-300 hover:shadow-xl hover:border-cyan-500/50 hover:shadow-cyan-500/20">
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-cyan-500/10 to-purple-500/10 pointer-events-none" />
              <CardContent className="relative pt-6 h-full flex flex-col">
                <h3 className="text-xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                  Contact Information
                </h3>

                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="bg-cyan-500/20 border border-cyan-500 text-cyan-400 p-3 rounded-full mr-4">
                  ...
                  <div className="flex items-start">
                    <div className="bg-purple-500/20 border border-purple-500 text-purple-400 p-3 rounded-full mr-4">
                  ...
                  <div className="pt-4">
                    ...
                    <div className="flex space-x-3">
                      <a
                        ...
                        className="bg-gray-700 hover:bg-blue-600 text-gray-200 hover:text-white p-3 rounded-full transition-colors"
                        aria-label="GitHub"
                      >
                        <svg
